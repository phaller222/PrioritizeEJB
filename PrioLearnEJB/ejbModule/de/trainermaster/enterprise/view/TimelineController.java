package de.trainermaster.enterprise.view;
...
public class TimelineController implements Serializable {
    ...
    public void updateTimeline() {
        ...
        if (sessionController.getUser() != null) {
            ...
            // Set zoomlevel
            model.add(TimelineEvent.builder().data("START 2023").startDate(LocalDate.of(2023, 1, 1)).build());
            model.add(TimelineEvent.builder().data("ENDE 2023").startDate(LocalDate.of(2023, 12, 31)).build());
