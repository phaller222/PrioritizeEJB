define({ "api": [
  ...
  },
  {
    ...
    "group": "_resources",
    "description": "<p>Searches for a resource with the given uuid.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "get",
    "url": "uuid/{uuid}/mqttOnline",
    "title": "",
    "name": "isResourceOnline",
    "group": "_resources",
    "description": "<p>returns if the resource with the given uuid is online.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "get",
    "url": "id/{id}/mqttOnline",
    "title": "",
    "name": "isResourceOnlineById",
    "group": "_resources",
    "description": "<p>returns if the resource with the given id is online.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "get",
    "url": "search/{departmentToken}",
    "title": "",
    "name": "searchResources",
    "group": "_resources",
    "description": "<p>Searches the given department for resources with phrase.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  {
    "type": "post",
    "url": "/command?apiKey={apiKey}",
    "title": "sendCommand",
    "name": "sendCommand",
    "group": "_resources",
    "description": "<p>sends a command to a resource</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "group",
            "description": "<p>The resource group of the device.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "uuid",
            "description": "<p>The uuid of the resource.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "command",
            "description": "<ul> <li>the command to send</li> </ul>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "value",
            "description": "<ul> <li>the value sent with the command</li> </ul>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "url": "uuid/{uuid}",
    "title": "",
    "name": "setResourceAttributesByUuid",
    "group": "_resources",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<ul> <li>The user id of the user to retrieve.</li> </ul>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "username",
            "description": "<ul> <li>The username of the user to retrieve.</li> </ul>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "departmentToken",
            "description": "<p>The department token of the department to search for users.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "name": "searchRoles",
    "group": "_users",
    "description": "<p>searches for roles</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "phrase",
            "description": "<ul> <li>The searchstring to search for.</li> </ul>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "JSON-Object",
            "description": "<p>with the roles found.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "name": "searchUsers",
    "group": "_users",
    "description": "<p>searches for users</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "JSON-Object",
            "description": "<p>with the users found.</p>"
          }
        ]
      },
      "examples": [
