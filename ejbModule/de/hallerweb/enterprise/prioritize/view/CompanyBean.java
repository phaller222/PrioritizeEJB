...
public class CompanyBean implements Serializable {
    ...
    public String createCompany() {
        if (controller.getCompanyByName(company.getName(), sessionController.getUser()) == null) {
            ...
            Address adr = controller.createAddress(address.getCountry(), address.getStreet(), address.getHousenumber(), address.getZipCode(),
     ...
     *
     * @param c {@link Company} object to be edited.
     * @return "editcompany".
     */
    @Named
     ...
     *
     * @param d {@link Department} to be edited.
